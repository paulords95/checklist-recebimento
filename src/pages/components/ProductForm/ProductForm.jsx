    ...
    <div>
      {post ? (
        <Alert severity="warning">
          O formulário para o recebimento nº {currentProduct.USU_CODREC} foi
          salvo com sucesso!
        </Alert>
      ) : (
        <>
          ...
          <form className="radio-form-product">
            <div>
              3. Todas as embalagens estão devidamente identificadas e o número
              do lote, datas de fabricação e validade estão de acordo com o
              laudo enviado?
            </div>
            <div className="radios">
              <div>
